...
const styles = StyleSheet.create({
    nav: { flexDirection: 'row', position: 'absolute', bottom: 0, paddingBottom: scale(0.6), paddingTop: scale(0.4), backgroundColor: 'rgba(0,0,0,0.21)' },
        ...
        <View style={styles.nav} >
            {
                [
                    ...
                    { image: ImageMenu, text: capitalize(t('products')), onPress: () => {} },
                    { image: ImageConfig, text: capitalize(t('config')), onPress: () => {} }

                ].map( ({image, text, onPress}, key) => (
                    <TouchableOpacity style={styles.button} key={key} onPress={onPress} >
                        <Image source={image} resizeMode='contain' style={styles.button_icon} />
