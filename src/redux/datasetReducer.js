import {
  ...
  DELETE_ITEM_FROM_DATASET_LIST_REDUCER,
  SET_ITEM_TO_DATASET_LIST_REDUCER
} from './constants.json'
...
let datasetReducer = (state = initialState, action) => {
  ...
  if (debug) console.log('REDUCERS - datasetReducer ===> ', {
    action
  })
  ...
  switch (type) {
    case SET_ITEM_TO_DATASET_REDUCER:
      ...
      else if (typeof data === 'object') state[dataset_name] = {
        ...data
      }
