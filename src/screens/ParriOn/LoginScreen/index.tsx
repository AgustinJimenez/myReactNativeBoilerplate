...
import { logAction, callbackVoidSagaAction } from '../../../actions'
import { KeyboardAwareScrollView } from 'react-native-keyboard-aware-scroll-view'



const styles = StyleSheet.create({
    welcome: { color: 'white', textAlign: 'center', fontSize: 41, fontWeight: '500', fontFamily: 'Reckoner' },
    register: {
    ...
    registerText: { color: brandSecondary.brandSecondary, textAlign: 'center', paddingHorizontal: scale(0.1)/* , fontFamily: 'CircularStd'  */},
    
})

const formIsValid = ( email: string, password: string, login_is_loading: boolean ) => {
...
const LoginScreen = ({  }) => {
    ...
    const email: string = useSelector( state => datasetSelector(state, 'login_email') )
    const login_is_loading: boolean = useSelector( state => datasetSelector(state, 'login_is_loading') )
            ...
            >
                <View style={styles.formContainer}>
                    <Form style={styles.form}>
                        ...
                        <Button 
                            block 
                            style={[styles.sigInButton, !inputsValid && styles.sigInButtonDisabled ]} 
